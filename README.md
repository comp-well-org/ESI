...
H Yu, P Guo, A Sano, ECG Semantic Integrator (ESI): A Foundation ECG Model Pretrained with LLM-Enhanced Cardiological Text

Transactions on Machine Learning Research (TMLR) 2024 October
...
## License
ESI is released under the GPL 3.0. See [LICENSE](https://github.com/comp-well-org/ESI/blob/main/LICENSE.txt) for details.
